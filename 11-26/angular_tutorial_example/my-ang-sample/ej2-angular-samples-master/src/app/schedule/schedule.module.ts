...
export const scheduleRouteConfig: Record<string, any>[] = [
  { path: ':theme/schedule/overview2', component: OverviewComponent, name: '연습및 적용', order: '01', category: 'Scheduler', description: 'This example demonstrates the overview functionalities in Angular Scheduler Component.' },
  ...
  { path: ':theme/schedule/realtime-binding', component: RealTimeBindingComponent, name: 'Real-Time Binding', order: '02', category: 'Appointments', type: 'new', description: 'This demo showcases the way of binding signalR services to Scheduler component. Here, the SignalR is used to bind the data with Scheduler.' },
  ...
  { path: ':theme/schedule/resources', component: ResourcesComponent, name: 'Fare Calendar', order: '06', category: 'Multiple Resources', description: 'This demo is a real-time airfare calendar showcase application with flight and airfare details using the Angular Scheduler control.' },
  { path: ':theme/schedule/resource', component: ResourceComponent, name: 'Resources', order: '06', category: 'Multiple Resources', description: 'This Angular Scheduler control example depicts how to show or hide appointments or events based on selected resources among multiple resources.' },
  { path: ':theme/schedule/group-editing', component: GroupEditingComponent, name: 'Shared Events ', order: '06', category: 'Multiple Resources', description: 'This demo presents event (appointment) sharing, which enables a single event to be shared by multiple resources in the Angular Scheduler event calendar.' },
  { path: ':theme/schedule/group-custom-work-days', component: GroupCustomWorkDaysComponent, name: 'Different Work Days', order: '06', category: 'Multiple Resources', description: 'This demo shows how to set different workdays for each resource in a group to build a doctor availability application in the Angular event calendar.' },
  { path: ':theme/schedule/add-remove-resources', component: AddRemoveResourcesComponent, name: 'Show/Hide Resources', order: '06', category: 'Multiple Resources', description: 'This demo shows how to dynamically add or remove resources from the Angular Scheduler layout along with their appointments (events).' },
  ...
  { path: ':theme/schedule/work-hours', component: WorkHoursComponent, name: 'Work Hours', order: '10', category: 'Customization', description: 'This demo shows how to customize the work hour range on the Angular Scheduler calendar, allowing business hours other than 9 AM to 6 PM.' },
  { path: ':theme/schedule/start-end-hour', component: StartEndHourComponent, name: 'Day Hour Limit', order: '10', category: 'Customization', description: 'This demo shows how to limit the start and end hours in the Angular Scheduler which is applicable for all views and used here to render business hours only.' },
  { path: ':theme/schedule/cell-dimension', component: CellDimensionComponent, name: 'Cell Dimension', order: '10', category: 'Customization', description: 'This demo shows how to change the default width and height of work cells, allowing the Angular Scheduler to be viewable zoomed in or zoomed out.' },
  ...
  { path: ':theme/schedule/reminder', component: ReminderComponent, name: 'Reminder', order: '10', category: 'Customization', type: 'new', description: 'This demo showcases an event reminder notification that will be displayed after 5 seconds of sample getting loaded.' },
  ...
  { path: ':theme/schedule/events', component: EventsComponent, name: 'Events', order: '12', category: 'Miscellaneous', description: 'This demo lists the client-side events triggered on Angular Scheduler actions in the Event Tracer. The Event Tracer also includes a Clear option.' }
];
...
const scheduleDeclarations: Type<Record<string, any>>[] = [
  ...
  OverviewComponent, MultiDragComponent, AdaptiveGroupingComponent, RealTimeBindingComponent, ReminderComponent
];
