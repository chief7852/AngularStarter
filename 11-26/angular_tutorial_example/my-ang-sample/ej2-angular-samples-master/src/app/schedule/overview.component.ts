...
export class OverviewComponent implements AfterViewChecked {
  ...
  public exportItems: ItemModel[] = [
    ...
    { text: '엑셀', iconCss: 'e-icons e-export-excel' }
  ];
  ...
  public menuItems: MenuItemModel[] = [
    { text: '새 일정', iconCss: 'e-icons e-plus', id: 'Add' },
    { text: '새로운 반복 이벤트', iconCss: 'e-icons e-repeat', id: 'AddRecurrence' },
    { text: '오늘', iconCss: 'e-icons e-timeline-today', id: 'Today' },
    { text: '이벤트 수정', iconCss: 'e-icons e-edit', id: 'Save' },
    {
      text: '이벤트 수정', id: 'EditRecurrenceEvent', iconCss: 'e-icons e-edit',
      items: [
        { text: '편집 발생', id: 'EditOccurrence' },
        { text: '시리즈 편집', id: 'EditSeries' }
      ]
    },
    { text: '이벤트 삭제', iconCss: 'e-icons e-trash', id: 'Delete' },
    {
      text: '이벤트 삭제', id: 'DeleteRecurrenceEvent', iconCss: 'e-icons e-trash',
      items: [
        { text: '발생 삭제', id: 'DeleteOccurrence' },
        { text: '시리즈 삭제', id: 'DeleteSeries' }
      ]
    }
  ];
  ...
  public generateEvents(): Record<string, any>[] {
    ...
    const eventSubjects: string[] = [
      '일시 구분', '테크놀로지', '유지', '일자 구분', '여행', '연례 회의', '생일 축하',
      '테스트1', '테스트2', '테스트3', '테스트4', '테스트5', '테스트6', '테스트7',
      '테스트8', '테스트9', '테스트10', '테스트11', '테스트12', '테스트13', '테스트14', '테스트15'
    ];
  ...
  public getHeaderTitle(data: Record<string, any>): string {
    return (data.elementType === 'cell') ? '약속 추가' : 'Appointment Details';
  }
