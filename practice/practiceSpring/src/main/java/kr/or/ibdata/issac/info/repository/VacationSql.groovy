...
VALUES(:day_cnt, :dept_cd, :dept_nm, :emp_nm, :emp_no, :job_vaus_emp, :job_vaus_emp_no, :remndr_yryc, :reqst_dt, :rmk, :time_cnt, :vac_cls, :vac_applcnt_clsf, :vac_dept_cd, :vac_dept_nm, :vac_emgnc_tel_no, :vac_emp_nm, :vac_emp_no, :vac_end_dt, :vac_stdde, :vac_st_dt, :vac_time_cls1, :vac_time_cls2, :vac_use_dt, :vaus_applcnt_clsf);
